      ...
      >
        <t-row justify="space-between">
          <div class="left-operation-container">
            <t-button @click="handleSetupContract">添加词条</t-button>
            <t-button variant="base" theme="default" :disabled="!selectedRowKeys.length"> 导出词条</t-button>
...
export default Vue.extend({
  ...
  methods: {
    ...
    page() {
      ...
      this.$request.get('/wallpaper/userPrompt/page', {
